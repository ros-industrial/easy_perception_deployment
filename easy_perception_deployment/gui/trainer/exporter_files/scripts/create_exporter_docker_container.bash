...
# Function: Create Export Docker Container from Export Docker Image, epd-exporter
# Static Analysis: shellcheck create_exporter_docker_container.bash -x -e SC1091
